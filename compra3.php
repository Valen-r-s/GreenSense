      ...
      <div class="contenido">
        ...
        <div class="resumen">
          ...
          <div class="descripcion-producto">
            <img src="./img/ProductoNina.jpg" alt="Jardinero arbusto" />
            <h3>Nombre del producto</h3>
            <p>Jardinero jardinera</p>
            <h3>Precio</h3>
            <p class="precio">$150.000</p>
            <h3>Descripción</h3>
            <p>Sensor de humedad y temperatura con forma de jardinera.</p>
          </div>
        </div>
      </div>
      <a href="https://pay.sumup.com/b2c/XUIT687JK0"><button name="pagar">Pagar</button></a>
      <a href="./tiendaProduct3.html"><button name="volver">Volver</button></a>
    </main>
    <footer>
